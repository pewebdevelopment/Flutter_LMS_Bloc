...
class Unotification extends StatefulWidget {
  ...
  @override
  State<Unotification> createState() => _UnotificationPage();
}

class _UnotificationPage extends State<Unotification> {

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<UnotificationBloc, UnotificationState>(builder: (context, state) {
      return Scaffold(
        appBar: _buildAppBar(),
